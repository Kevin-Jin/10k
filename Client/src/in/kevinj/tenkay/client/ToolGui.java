package in.kevinj.tenkay.client;

import in.kevinj.tenkay.client.model.Dispatchers;
...
public class ToolGui extends JApplet {
	...
	private static void setTrayAndTitleBarIcon(Model m, final JFrame frame) {
		Image favicon = Toolkit.getDefaultToolkit().getImage(ToolGui.class.getResource("/resources/favicon.png"));
